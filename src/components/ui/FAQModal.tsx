...
const FAQModal: React.FC<FAQModalProps> = ({ isOpen, onClose }) => {
  ...
  const faqItems: FAQItem[] = [
    ...
    {
      id: 6,
      question: "Что такое VLESS и чем он лучше других протоколов?",
      answer: [
    ...
    },
    {
      ...
      answer: [
        ...
        "Высокая производительность: Меньший накладной расход и более простая структура пакетов по сравнению с VMess обеспечивают лучшую скорость."
        "Безопасность: VLESS не имеет встроенного шифрования, что позволяет гибко использовать современные и более надежные технологии шифрования трафика (такие как TLS 1.3) на транспортном уровне."
        "Стабильность: Благодаря простоте и эффективности, VLESS лучше обходит блокировки и обеспечивает стабильное соединение."
        "Совместимость с XTLS: Позволяет использовать технологию XTLS для прозрачного проксирования, что значительно снижает нагрузку на процессор и еще больше повышает скорость."
      ]
    },
    {
      id: 8,
      ...
      answer: [
        ...
        "В то время как OpenVPN и WireGuard легко обнаруживаются и блокируются провайдерами, VLESS в сочетании с Transport Layer Security (TLS) маскирует ваш трафик под обычный HTTPS-трафик, что делает его практически неотличимым для систем глубокой проверки пакетов (DPI)"
      ]
    }   
  ];
