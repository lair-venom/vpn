  ...
  const tutorials = [
    {
      ...
      content: [
        "Выбирайте подходящий вам тариф и длительность и оплачивайте его. После того как вы оплатили вам необходимо связаться с Администратором удобным для вас способом Discord или Telegram (ссылки находятся в блоке оплаты, где указан номер карты) и предоставить чек об оплате. Далее в течение 5 минут вам будет выдан полный доступ и данные для вашего VPN.. ",
      ]
    },
    {
      id: 2,
      ...
      content: [
        "В блоке оплаты находятся ссылки на нашего Telegram бота в котором предоставлена информация связанная с вашим VPN а так же приходят различные полезные уведомления в случаи тех.работ. Так же в блоке оплаты есть ссылка на наш Discord сервер и при возникновении каких либо проблем или же вопросов вы сможете обратиться напрямую к нашему специалисту создав тикет в канале vpn-venom.",
      ]
    },
    {
      id: 3,
