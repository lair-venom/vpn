  ...
  const tutorials = [
    {
      ...
      content: [
        "Выбирайте подходящий вам тариф и оплачивайте его. После того как вы оплатили вам необходимо связаться с Администратором удобным для вас способом Discord или Telegram (ссылки находятся в блоке оплаты, где указан номер карты) и предоставить чек об оплате. Далее в течение 5 минут вам будет выдан полный доступ и данные для вашего VPN. ",
      ]
    },
    {
      id: 2,
