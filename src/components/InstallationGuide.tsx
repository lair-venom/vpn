      ...
      <div className="container-custom relative">
        ...
        <div className="lg:w-3/5">
          <InstallStep 
            ...
            description="Выберите соответствующую версию VPN клиента для вашего устройства и операционной системы. Загрузите установочный файл с нашего официального сайта."
